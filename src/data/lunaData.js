...
export const ARTICLES = [
  ...
  { id: 'privacy',  cat: 'Your Data',    tag: 'Read this',        read: '3 min', title: 'How Luna handles your cycle data — in plain English',  summary: 'On-device by default. Encrypted with AES-256. No third-party tracking. You control exports and deletion.', body: [
    'Your cycle data — every log, every symptom, every note — is encrypted on this device with AES-256 before it touches storage. The encryption key is derived from your passcode and never leaves your device.',
    'We do not sell or share your data. We do not run third-party analytics, advertising trackers, or behavioural fingerprinting inside the app.',
    'If you create an account, your email lives on our auth provider (Supabase) so we can sign you in across devices. Your cycle data stays encrypted on your phone — it never reaches our servers in readable form. The two are stored separately and unlinked.',
    'There is no AI built into Luna today. If we add AI features later, they will be opt-in per conversation, with clear consent before any of your data is shared with an AI provider.',
    'You can export everything as CSV at any time. You can also delete everything in one step from Settings → Privacy & Data → Delete everything.',
    'We support full account deletion within 30 days of request via Settings → Delete my account. We do not retain a copy.',
    'Because we cannot decrypt your cycle data, we cannot comply with legal requests to share it. This is by design — particularly relevant for reproductive health data in jurisdictions where it may be used against you.',
  ], sources: [
    'Luna data handling policy',
    'WebCrypto AES-256-GCM (browser-native encryption)',
