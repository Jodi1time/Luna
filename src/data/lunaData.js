...
export const ARTICLES = [
  ...
  { id: 'privacy',  cat: 'Your Data',    tag: 'Read this',        read: '2 min', title: 'How Luna handles your cycle data — in plain English',  summary: 'On-device. AES-256 encrypted. No tracking. You control exports and deletion.', body: [
    'Your cycle data is encrypted on this device with AES-256 before storage. The key comes from your passcode and never leaves your device.',
    'No selling, no sharing. No third-party analytics or advertising trackers inside the app.',
    'If you create an account, only your email reaches our auth provider (Supabase) — to sign you in across devices. Cycle data stays encrypted on your phone. The two are stored separately.',
    'No AI in Luna today. Future AI features will be opt-in per conversation with clear consent.',
    'Export everything as CSV any time. Delete everything in one step from Settings → Delete everything.',
    'Full account deletion within 30 days via Settings → Delete my account. We do not keep a copy.',
    'Because we cannot decrypt your cycle data, we cannot share it under legal request. By design — particularly for reproductive health data.',
  ], sources: [
