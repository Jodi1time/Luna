// Galaxy — animated star-field background from React Bits.
// WebGL shader via ogl (~40KB gzipped, much lighter than three.js).
// Stock source from React Bits, unchanged. Lazy-loaded by Backdrop.jsx
// so the ogl dep only ships for users who pick this atmosphere.
