// ColorBends — React Bits multi-colour shader. Up to 8 colours
// blended into flowing bands via a fragment shader on a fullscreen
// plane (three.js). Stock source from React Bits, unchanged.
