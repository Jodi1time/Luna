...
import Home         from './screens/PremiumHome'
import Log          from './screens/PremiumLog'
...
const PcosDoctorScript = lazy(() => import('./screens/PcosDoctorScript'))
...
function ScreenRenderer({ screen }) {
  switch (screen) {
    ...
    case 'pcosDoctorScript': return <PcosDoctorScript />
