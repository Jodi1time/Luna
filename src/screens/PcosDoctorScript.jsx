...
<div class="footer">For discussion with a healthcare provider — not a diagnosis. Information sourced from the International PCOS Guideline 2023, Endocrine Society Clinical Practice Guideline, and ACOG Practice Bulletin 194.
...
function buildPlainText(script) {
  ...
  lines.push('')
  lines.push(`— Prepared with Luna (lunadiary.app). Sources: International PCOS Guideline 2023, Endocrine Society Clinical Practice Guideline, ACOG Practice Bulletin 194.`)
  return lines.join('\n')
}
